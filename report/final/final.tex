...
We have tried other model-free methods such as Linear Q-learning (ref) and Double Deep Q-learning (ref) but they did not achieve better performance than our Deep Q-learning (ref?) implementation.
