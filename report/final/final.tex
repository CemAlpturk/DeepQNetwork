...
After playing around with the exploration rate $\epsilon$, we have found that a lower exploration rate performs better for this problem.
...
This is why we preferred to train the agent with a lower exploration rate, where the agent explores things to do rather than things to avoid.
...
This is why we need some exploration during training.
