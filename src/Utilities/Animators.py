...
def animate_multiple_double_pendulums(
    ...
    pendulum_1_arms = [None] * len(pendulums)
    ...
    for index, pendulum in enumerate(pendulums):
        ...
        pendulum_1_arms[index] = pendulumArm1
    ...
    def init():
        ...
        for index, arm_inner in enumerate(pendulum_1_arms):
        ...
        ret_val = carts + pendulum_1_arms + pendulum_2_arms + [time_text]
    ...
    def animate(i):
        for index, pendulum in enumerate(pendulums):
            ...
            pendulum_1_arms[index].set_xdata(xpos1)
            pendulum_1_arms[index].set_ydata(ypos1)
